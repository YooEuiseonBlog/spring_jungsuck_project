...
<script>
    ...
    let showList = function(bno) {
        $.ajax({
            ...
            // headers : { "content-type": "application/json"}, // 요청 헤더 // 디폴트 content type : application/json // 보낼 때만 사용
            // dataType : 'text', // 전송받을 데이터의 타입 // 디폴트 dataType:json
