...
public class BoardDaoImplTest {
    ...
    public void searchSelectPageTest() throws Exception {
        boardDao.deleteAll();
        for (int i = 1; i <= 20; i++) {
            BoardDto boardDto = new BoardDto("title"+i, "hello! jet world.", "Yoo"+i);
        ...
        sc = new SearchCondition(1, 10, "Yoo2", "W");   // Yoo2%
        list = boardDao.searchSelectPage(sc);
        System.out.println("list2 = " + list);
        assertTrue(list.size()==2); // 1~20 Yoo2, Yoo20
    }
    ...
    public void searchResultCntTest() throws Exception {
        ...
        sc = new SearchCondition(1, 10, "Yoo2", "W");
